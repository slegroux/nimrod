...
# %% auto 0
__all__ = ['logger', 'Vocab', 'SimpleCharDataset', 'CharDataset', 'CharDataModule']
...
from torch.utils.data import DataLoader, dataset, Dataset, random_split, RandomSampler
...
class SimpleCharDataset(Dataset):
    ...
    def __getitem__(self, idx):
        if idx + self.context_length + 1 > len(self.data):
            return
